...
export default function DashboardPage() {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-black relative">
      ...
      {/* ── Fixed background layers (same as LoginPage) ── */}
      ...
      {/* ── Header ── */}
      <header className="
        relative z-20 flex items-center gap-6 px-10 h-16
        border-b border-white/10 bg-black/90 backdrop-blur-sm
        animate-slide-down
      ">
        ...
        <section className="relative border border-white/15 bg-white/[0.03] px-12 py-10 overflow-hidden">
          ...
          <div className="flex items-center justify-between gap-8">
            <div className="flex-1">
              <p className="font-crimson text-lg italic text-white/55 mb-1">{greeting},</p>
              <h1 className="font-playfair font-black text-4xl md:text-5xl text-white leading-tight mb-3"
          ...
          <div className="flex items-center gap-4 mt-6">
            ...
            <span className="text-white/30 text-[0.55rem]">✦</span>
            <span className="flex-1 h-px bg-[linear-gradient(90deg,transparent,rgba(255,255,255,0.15),transparent)]" />
          </div>
        </section>
